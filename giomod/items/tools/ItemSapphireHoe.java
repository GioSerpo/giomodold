...
public class ItemSapphireHoe extends Item
{
    protected EnumToolMaterial theToolMaterial;

    public ItemSapphireHoe(int par1, EnumToolMaterial par2EnumToolMaterial)
    {
        super(par1);
	...
	{
		itemIcon = Par1.registerIcon("giomod:sapphirehoe");
	}
}