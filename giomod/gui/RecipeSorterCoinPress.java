...
class RecipeSorterCoinPress implements Comparator
{
    final CraftingManagerCoinPress CraftingManagerCoinPress;

    RecipeSorterCoinPress(CraftingManagerCoinPress par1CraftingManagerCoinPress)
    {
        this.CraftingManagerCoinPress = par1CraftingManagerCoinPress;
    }
