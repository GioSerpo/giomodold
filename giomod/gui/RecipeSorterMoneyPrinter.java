...
class RecipeSorterMoneyPrinter implements Comparator
{
    final CraftingManagerMoneyPrinter CraftingManagerMoneyPrinter;

    RecipeSorterMoneyPrinter(CraftingManagerMoneyPrinter par1CraftingManagerMoneyPrinter)
    {
        this.CraftingManagerMoneyPrinter = par1CraftingManagerMoneyPrinter;
    }
